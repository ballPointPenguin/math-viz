        ...
        <Box p="3" style={{ background: 'rgba(18, 18, 18, 0.8)', borderTop: '1px solid rgba(255, 255, 255, 0.1)' }}>
          <Flex direction="column" gap="3">
            <Flex align="center" justify="between">
              <Text size="2" style={{ color: 'rgba(255, 255, 255, 0.8)' }}>Circle Radius</Text>
              <Flex align="center" gap="2">
                <Text size="1" style={{ color: 'rgba(255, 255, 255, 0.6)' }}>{radius}px</Text>
                <Slider 
                  value={[radius]} 
                  min={minRadius} 
                  max={maxRadius} 
            ...
            {points.length > 0 && (
              <Box>
                <Flex justify="between" align="center" mb="2">
                  <Text size="2" style={{ color: 'rgba(255, 255, 255, 0.8)' }}>Points</Text>
                  <Button 
                    variant="ghost" 
                    onClick={clearPoints}
                    ...
                    return (
                      <Flex key={index} justify="between" align="center" py="1">
                        <Text size="1" style={{ color: 'rgba(255, 255, 255, 0.8)' }}>
                          P{index + 1}: {angleDeg}° ({normalizedX}, {normalizedY})
                        </Text>
                        <Button variant="ghost" size="1" onClick={() => removePoint(index)}>
                          <Cross2Icon />
                        </Button>
                      </Flex>
                    );
