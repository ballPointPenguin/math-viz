	...
	return (
		<Box p="4" style={{ maxWidth: "1200px", margin: "0 auto" }}>
			...
			<Text mb="5" size="3" style={{ color: "rgba(255, 255, 255, 0.7)" }}>
				A collection of interactive mathematical visualization components with a
				dark academia meets vaporwave aesthetic. These components can be used to
				create engaging, interactive educational experiences for mathematical
				concepts.
			</Text>
						...
						<Card size="2" style={{ background: "rgba(0, 0, 0, 0.2)" }}>
							<Flex direction="column" gap="4">
								...
								{selectedPoint && (
									...
									>
										<Text>
											Selected point: ({selectedPoint.x.toFixed(2)},{" "}
					...
					<Tabs.Content value="circle">
						<Card size="2" style={{ background: "rgba(0, 0, 0, 0.2)" }}>
							<Flex direction="column" gap="4">
								...
								<Text mb="3">
									An interactive unit circle visualization. Click on the circle
									to add points and explore trigonometric relationships. The
									component displays coordinates in both Cartesian and polar
									forms.
								</Text>
								...
								<InteractiveCircle
									...
									fixedPoints={[
										{
											angle: Math.PI / 4,
											x: Math.cos(Math.PI / 4) * 120,
											y: Math.sin(Math.PI / 4) * 120,
										},
										{
											angle: Math.PI / 2,
											x: Math.cos(Math.PI / 2) * 120,
											y: Math.sin(Math.PI / 2) * 120,
										},
									]}
								/>
							</Flex>
					...
					<Tabs.Content value="vector">
						<Card size="2" style={{ background: "rgba(0, 0, 0, 0.2)" }}>
							<Flex direction="column" gap="4">
								...
								<Text mb="3">
									Visualize vector operations including addition, subtraction,
									dot product, and cross product. Drag the vector endpoints to
									modify them, or use the sliders for precise control.
								</Text>
					...
					<Tabs.Content value="combined">
						<Card size="2" style={{ background: "rgba(0, 0, 0, 0.2)" }}>
							<Flex direction="column" gap="4">
								...
								<Text mb="3">
									This demo shows how the components can be combined to create
									more complex visualizations. The example below shows a
									coordinate grid with a unit circle and vectors.
								</Text>
								...
								<Box>
									...
									>
										<li>
											Customizable colors for background, grid, axes, and
											elements
										</li>
										<li>
											Adjustable dimensions (width, height) and fullWidth option
										</li>
